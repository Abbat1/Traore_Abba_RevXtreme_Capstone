...
const UpdateCar = ({ car }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`http://localhost:8080/api/cars/${updatedCar.id}`, {...updatedCar, imageSrc: state.imageSrc})
      .then(response => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      {/* <input type="text" name="url" value={state.imageSrc} onChange={handleChange} /> */}
