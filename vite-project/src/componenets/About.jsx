import '../components_styles/Homepage.css'; // Importing CSS styles for the component
    ...
    <div>
      ...
      <section className="About" id="About" style={{ marginBottom: '6%' }}>
        <div className="About-content">
          <h1>Our Tradition</h1> {/* Section title */}
        </div>
        <div className="Section-1">
          ...
          <h2>The What?</h2> {/* Subsection title */}
          <h2 style={{ marginLeft: '500px', marginTop: '120px' }}></h2> {/* Empty h2 for spacing */}
          ...
          <p1 style={{
            ...
            earth-shaking excitement of modified vehicles to every passionate driver who's ever dreamed of pushing the limits and turning heads.
          </p1>
        </div>
      </section>
      ...
      <section className="About" id="About" style={{ marginBottom: '6%' }}>
        ...
        <div className="Section-1">
          ...
          /> {/* Image with inline styling */}
          <h2>The Why</h2> {/* Subsection title */}
          <h2 style={{ marginLeft: '500px', marginTop: '120px' }}></h2> {/* Empty h2 for spacing */}
          <p style={{
            fontSize: '17px',
            fontFamily: 'Courier New',
            ...
            {/* Paragraph describing the company's origin story */}
      ...
      <section className="About" id="About" style={{ marginBottom: '6%' }}>
        ...
        <div className="Section-1">
          ...
          /> {/* Image with inline styling */}
          <h2> The How</h2> {/* Subsection title */}
          <h2 style={{ marginLeft: '500px', marginTop: '120px' }}></h2> {/* Empty h2 for spacing */}
          <p style={{
            fontSize: '17px',
            fontFamily: 'Courier New',
            ...
            {/* Paragraph describing the company's mission and vision */}
      ...
      <footer style={{ backgroundColor: 'gray' }}>
        <form className="cta-form">
          <input type="email" placeholder="Enter Email" required /> {/* Email input field */}
          <button type="submit">Subscribe and Save 5%</button> {/* Submit button */}
        </form>
        <h4>&copy; 2024 RevXtreme. All rights reserved.</h4> {/* Footer text */}
      </footer>
    </div>
  );
};
